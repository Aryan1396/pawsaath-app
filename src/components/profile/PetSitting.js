...
export default function PetSitting({ onSelect }) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.firstnevigation}>
                    ...
                    <View>
                        <Text style={styles.PetBoardingText} >PET SITTING</Text>
                    </View>
                </View>
                ...
                <View>
                    ...
                    <View>
                        ...
                        <View style={styles.pricesInformation}>
                            <Text style={styles.pricesInformationtext}>Half-day <Text style={styles.pricesInformationtextSecondey}>upto 4 hrs</Text> </Text>
                            <Text style={styles.pricesInformationtext}>Full-day <Text style={styles.pricesInformationtextSecondey}>upto 10 hrs</Text></Text>
                            <Text style={styles.pricesInformationtext}>overnight <Text style={styles.pricesInformationtextSecondey}>upto 24 hrs</Text></Text>
                        </View>
                        <View style={styles.petNameText}>
                            <Text>Dog</Text>
                            <Text>Cat</Text>
                        </View>
                        ...
                        <View>
                            ...
                            <View style={styles.inputboxcontainer}>
                                <TextInput style={styles.pricesinputfiled4}
                                    keyboardType='number'
                                />
                                <TextInput style={styles.pricesinputfiled5}
                                    keyboardType='number'
                                />
                                <TextInput style={styles.pricesinputfiled6}
                                    keyboardType='number'
                                />
                            </View>
                        </View>
                        ...
                        <View>
                            <Text style={styles.petsizeText}>Sizes of Pets you intake</Text>
                        ...
                        {/* Ages of Pets you can sit and their input field */}
                        <View>
                            <Text style={styles.petAgeText}>Ages of Pets you can sit</Text>
                            <View style={styles.pettoggleContaineroneForAge}>
                                <TouchableOpacity
                                    style={[styles.pettoggleButton, selectedPetAge === 'Junior' && styles.petselectedButton]}
                                    onPress={() => setSelectedPetAge('Junior')}
                                >
                                    <Text style={[styles.pettoggleText, selectedPetAge === 'Junior' && styles.petselectedText]}>Junior</Text>
                                </TouchableOpacity>

                                <TouchableOpacity
                                    style={[styles.pettoggleButton, selectedPetAge === 'Medium' && styles.petselectedButton]}
                                    onPress={() => setSelectedPetAge('Medium')}
                                >
                                    <Text style={[styles.pettoggleText, selectedPetAge === 'Medium' && styles.petselectedText]}>Medium</Text>
                                </TouchableOpacity>

                                <TouchableOpacity
                                    style={[styles.pettoggleButton, selectedPetAge === 'Senior' && styles.petselectedButton]}
                                    onPress={() => setSelectedPetAge('Senior')}
                                >
                                    <Text style={[styles.pettoggleText, selectedPetAge === 'Senior' && styles.petselectedText]}>Senior</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    pricesInformationtext: {
        width: 80,
        fontSize: 18,
        fontWeight: "900",
        marginTop: 10
    },
    pricesInformationtextSecondey: {
        fontSize: 14,
        fontWeight: "400"
    },
    petNameText: {
