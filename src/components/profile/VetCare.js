...
export default function Vetcare({ onSelect }) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.firstnevigation}>
                    ...
                    <View>
                        <Text style={styles.PetBoardingText} >VET CARE</Text>
                    </View>
                </View>
                ...
                <View style={styles.Secondcheckbox}>
                    <Text style={styles.last_check_box_main_text}>Can you provide online consultations ?</Text>
                    <View style={styles.lastcheckboxContainerinput}>
                        <TouchableOpacity
                            style={styles.lastcheckboxContainer}
                            onPress={() => handleSelect(1, 'yes')}
