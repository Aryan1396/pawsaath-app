...
export default function PetWalker({ onSelect }) {
    ...
    // List of certification options
    const certifications = [
        'Pet First Aid & CPR',
        'Professional Pet Walker Certificate',
    ...
    const handleSelectCertification = (option) => {
        if (option === 'None of the Above') {
            // If "None of the Above" is selected, deselect other options
            setSelectedCertifications(['None of the Above']);
        } else {
            if (selectedCertifications.includes(option)) {
                // If option is already selected, deselect it
                setSelectedCertifications(selectedCertifications.filter(item => item !== option));
            } else {
                // Otherwise, add the option (deselect "None of the Above")
                setSelectedCertifications([
                    ...selectedCertifications.filter(item => item !== 'None of the Above'),
                    option
                ]);
            }
        }
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.firstnevigation}>
                    ...
                    <View>
                        <Text style={styles.PetBoardingText} >PET WALKER</Text>
                    </View>
                </View>
                ...
                <View>
                    <View style={styles.inputboxcontainer}>
                        <View>
                            <Text style={styles.uppertextofpriceinputfield1}>15-min walk</Text>
                        ...
                        <View>
                            <Text style={styles.uppertextofpriceinputfield2}>Twice a Day</Text>
                    ...
                    <View style={styles.inputboxcontainer1}>
                        <View>
                            <Text style={styles.uppertextofpriceinputfield3}>Weekly Walk</Text>
                        ...
                        <View>
                            <Text style={styles.uppertextofpriceinputfield4}>Monthly Walk</Text>
                ...
                <View style={styles.containerOfcertifications}>
                    <Text style={styles.title}>Select if you have any certifications:</Text>

                    {certifications.map((certification, index) => (
                        <TouchableOpacity
                            key={index}
                            style={styles.checkboxContainer}
                            onPress={() => handleSelectCertification(certification)}
                        >
                            <View style={styles.checkbox}>
                                {selectedCertifications.includes(certification) && <View style={styles.checked} />}
                            </View>
